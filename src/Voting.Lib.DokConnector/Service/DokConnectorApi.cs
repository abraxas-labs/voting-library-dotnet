...
/// </summary>
public class DokConnectorApi : IDokConnector
{
    private readonly HttpClient _client;
    private readonly ILogger<DokConnectorApi> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="DokConnectorApi"/> class.
    /// </summary>
    /// <param name="client">The HTTP client.</param>
    /// <param name="logger">The logger.</param>
    public DokConnectorApi(HttpClient client, ILogger<DokConnectorApi> logger)
    {
        _client = client;
        _logger = logger;
    }
        ...
        CancellationToken ct)
    {
        ...
        requestContent.Add(fileStreamContent, "file", fileName);
