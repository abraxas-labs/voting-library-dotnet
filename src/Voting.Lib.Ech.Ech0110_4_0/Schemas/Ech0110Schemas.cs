...
namespace Voting.Lib.Ech.Ech0110_4_0.Schemas;

/// <summary>
/// eCH-0110 schema loader.
/// </summary>
public sealed class Ech0110Schemas
{
    [SuppressMessage(
        "SonarQube",
    ...
    private Ech0110Schemas()
    {
    }

    /// <summary>
    /// Builds an eCH-0110 schema set.
    /// </summary>
    /// <returns>The created schema set.</returns>
    public static XmlSchemaSet LoadEch0110Schemas()
        => XmlUtil.LoadSchemasFromResources<Ech0110Schemas>(Schemas);
}
