...
namespace Voting.Lib.Ech.Ech0045_4_0.Schemas;

/// <summary>
/// eCH-0045 schema loader.
/// </summary>
public sealed class Ech0045Schemas
{
    [SuppressMessage(
        "SonarQube",
    ...
    private static readonly Dictionary<string, string> Schemas = new()
    {
        ...
        ["http://www.ech.ch/xmlns/eCH-0045/4"] = "eCH-0045-4-0.xsd",
    ...
    /// <summary>
    /// Builds an eCH-0045 schema set.
    /// </summary>
    /// <returns>The created schema set.</returns>
    public static XmlSchemaSet LoadEch0045Schemas()
        => XmlUtil.LoadSchemasFromResources<Ech0045Schemas>(Schemas);
}
