...
namespace Ech0011_9_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("dwellingAddressType", Namespace="http://www.ech.ch/xmlns/eCH-0011/9")]
    ...
    public partial class DwellingAddressType
    {
        ...
        public Ech0010_8_0.SwissAddressInformationType Address { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("dwellingAddressValidFrom", Order=6, DataType="date")]
        public System.DateTime DwellingAddressValidFrom { get; set; }
    }
}
