...
namespace Ech0252_2_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ElectionResultTypeMajoralElection", Namespace="http://www.ech.ch/xmlns/eCH-0252/2", AnonymousType=true)]
    ...
    public partial class ElectionResultTypeMajoralElection
    {
        ...
        /// <summary>
        /// <para>element ist always supplied for all candidates that are known now. So candidate and candidateResult have always the same number of elements</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("element ist always supplied for all candidates that are known now. So candidate a" +
            "nd candidateResult have always the same number of elements")]
