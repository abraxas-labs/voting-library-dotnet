...
namespace Ech0228_1_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ElectionInformationTypeWriteInCodesWriteInCodeDesignation", Namespace="http://www.ech.ch/xmlns/eCH-0228/1", AnonymousType=true)]
    ...
    public partial class ElectionInformationTypeWriteInCodesWriteInCodeDesignation
    {
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute()]
        [System.Xml.Serialization.XmlElementAttribute("codeDesignationText", Order=1)]
        public string CodeDesignationText { get; set; }
    }
}
