...
dotnet xscgen ./Schemas/eCH-0252-2-0.xsd --netCore --separateFiles --output=./Models --nullable --order  --serializeEmptyCollections --collectionSettersMode=Public --generatedCodeAttribute- --collectionType="System.Collections.Generic.List`1" --commandArgs- -n http://www.ech.ch/xmlns/eCH-0006/2=Ech0006_2_0 -n http://www.ech.ch/xmlns/eCH-0007/6=Ech0007_6_0 -n http://www.ech.ch/xmlns/eCH-0008/3=Ech0008_3_0 -n http://www.ech.ch/xmlns/eCH-0010/6=Ech0010_6_0 -n http://www.ech.ch/xmlns/eCH-0044/4=Ech0044_4_1 -n http://www.ech.ch/xmlns/eCH-0058/5=Ech0058_5_0 -n http://www.ech.ch/xmlns/eCH-0155/5=Ech0155_5_0 -n Ech0252_2_0

if %errorlevel% neq 0 exit /b %errorlevel%

REM eCH-0252-2-0 references eCH-0155-5-0, but because CandidateType of eCH-0252-2-0 extends eCH-0155-5-0, we need to generate it seperately to remove automatically generated code which leads to a circular reference
echo Generating eCH-0155-5-0
dotnet xscgen ./Schemas/eCH-0155-5-0.xsd --netCore --separateFiles --output=./Models --nullable --order  --serializeEmptyCollections --collectionSettersMode=Public --generatedCodeAttribute- --collectionType="System.Collections.Generic.List`1" --commandArgs- -n http://www.ech.ch/xmlns/eCH-0006/2=Ech0006_2_0 -n http://www.ech.ch/xmlns/eCH-0007/6=Ech0007_6_0 -n http://www.ech.ch/xmlns/eCH-0008/3=Ech0008_3_0 -n http://www.ech.ch/xmlns/eCH-0010/6=Ech0010_6_0 -n http://www.ech.ch/xmlns/eCH-0044/4=Ech0044_4_1 -n Ech0155_5_0
