...
namespace Voting.Lib.Ech.Ech0159_5_1.Schemas;

/// <summary>
/// eCH-0159 schema loader.
/// </summary>
public sealed class Ech0159Schemas
{
    [SuppressMessage(
        "SonarQube",
    ...
    private static readonly Dictionary<string, string> Schemas = new()
    {
        ...
        ["http://www.ech.ch/xmlns/eCH-0159/5"] = "eCH-0159-5-1.xsd",
    };

    private Ech0159Schemas()
    {
    }

    /// <summary>
    /// Builds an eCH-0159 schema set.
    /// </summary>
    /// <returns>The created schema set.</returns>
    public static XmlSchemaSet LoadEch0159Schemas()
        => XmlUtil.LoadSchemasFromResources<Ech0159Schemas>(Schemas);
}
