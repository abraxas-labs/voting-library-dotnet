...
namespace Ech0155_4_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ListUnionBallotTextTypeListUnionBallotTextInfo", Namespace="http://www.ech.ch/xmlns/eCH-0155/4", AnonymousType=true)]
    ...
    public partial class ListUnionBallotTextTypeListUnionBallotTextInfo
    {
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute()]
        [System.Xml.Serialization.XmlElementAttribute("listUnionBalloText", Order=1)]
        public string ListUnionBalloText { get; set; }
    }
}
