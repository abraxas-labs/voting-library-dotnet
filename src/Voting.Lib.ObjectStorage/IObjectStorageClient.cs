...
public interface IObjectStorageClient
{
    ...
    Task EnsureBucketExists(string bucketName, CancellationToken ct = default);
    ...
    /// <param name="ct">The cancellation token.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    Task Delete(string bucketName, string objectName, CancellationToken ct = default);
    ...
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    Task Fetch(string bucketName, string objectName, Action<Stream> callback);
    ...
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    Task FetchAsBase64(string bucketName, string objectName, Action<Stream> callbackBase64);
    ...
    Task<string> FetchAsBase64(string bucketName, string objectName);
}
