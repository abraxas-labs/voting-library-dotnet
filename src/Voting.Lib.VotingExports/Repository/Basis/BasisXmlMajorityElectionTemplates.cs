...
public static class BasisXmlMajorityElectionTemplates
{
    ...
    /// <summary>
    /// Gets the eCH-0157 v5.1 (semantic v4.2) majority election export template.
    /// </summary>
    ...
    /// <summary>
    /// Gets the eCH-0157 v5.2 (semantic v4.3) majority election export template.
    /// </summary>
    public static readonly TemplateModel Ech0157_5_2 = new TemplateModel
    {
        Key = "majority_election_ech_0157_5_2",
        Filename = "eCH-0157_v5_2_{0}",
